...
|-----|------|------|-------------|
| `FLAME_PIN` | 34 | Analog Input | Flame/IR sensor |
| `SMOKE_PIN` | 35 | Analog Input | MQ smoke/gas sensor |
| `BUZZER_PIN` | 23 | Digital Output | Active buzzer |
| `LDR_PIN` | 32 | Analog Input | Ambient light sensor |
| `LED_PIN` | 2 | Digital Output | Smart LED |
| `TRIG1` / `ECHO1` | 5 / 18 | Digital | Ultrasonic sensor 1 (entry side) |
| `TRIG2` / `ECHO2` | 17 / 16 | Digital | Ultrasonic sensor 2 (exit side) |
| `SERVO_PIN` | 13 | PWM Output | Gate servo |
...
| Library | Install |
|---------|---------|
| [ESP32Servo](https://github.com/madhephaestus/ESP32Servo) | Arduino Library Manager → search `ESP32Servo` |
...
|-----------|----------|
| No hazard | Silent |
| Flame **or** Smoke | Slow beep (500ms interval) |
| Flame **and** Smoke | Rapid beep (100ms interval) |
...
```cpp
const int FLAME_THRESHOLD    = 50;    // ADC below this = fire detected
